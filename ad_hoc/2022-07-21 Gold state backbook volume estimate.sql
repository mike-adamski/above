...
SELECT DISTINCT
     ...
     , IFF(AMOUNT_FINANCED >= CASE WHEN STATE = 'CA' THEN 5000 WHEN STATE = 'MA' THEN 6500 ELSE 1000 END AND
           AMOUNT_FINANCED <= 71250, TRUE, FALSE) AS RULE_LOAN_AMOUNT
...
WHERE PROGRAM_STATUS IN ('Active', 'New Client', 'Enrolled')
  AND SERVICE_ENTITY_NAME = 'Five Lakes Law Group'
  AND BEYOND_ENROLLMENT_DATE < '2022-06-01';