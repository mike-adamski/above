...
--                , PC.IPL_ESTIMATED_LOAN_AMOUNT_C AS AMOUNT_FINANCED
               ...
               , 'Redacted' AS CFT_ROUTING_NUMBER   // FIX ME
               , 'Redacted' AS CFT_ACCOUNT_NUMBER   // FIX ME
               , 'Redacted' AS CFT_BANK_NAME    // FIX ME
...
--             AND DNC.DNC_NUMBER IS NULL
            ...
            -- Temporary logic; can be removed after this logic is built into Bedrock soon after launch
...
WHERE P.SERVICE_ENTITY_NAME = 'Beyond Finance'
  ...
  AND NOT (P.SERVICE_ENTITY_NAME = 'Beyond Finance' AND IPL.STATE IN ('GA', 'SC', 'OH'))
