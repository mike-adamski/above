CREATE OR REPLACE TABLE SNO_SANDBOX.MADAMSKI.ELIGIBILITY_MOCKUPS_20230901 AS
...
--Finding latest period where no completed transaction has been made
          ...
          WHERE 1 = 1
            ...
            AND AMOUNT_FINANCED BETWEEN 4750 AND 61750
            ...
            -- All TLs must be DQ enough to settle within 60 days
            AND PNS.PROGRAM_NAME IS NULL
            --Temporary logic which can be reverted once product fixes the field
